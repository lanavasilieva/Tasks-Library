...
### Project Setup
- Create a file named `TestAssignment.[extension]`. <br>
- For writing a solution for test assignment, it is sufficient to use only basic features of your langugage. Try to implement it using only basic libraries. <br>
- Don't wrap the file in package. <br>
- For Unit Testing create a file named `Test_TestAssignment.[extension]`. You may use any testing library you want for Unit testing.<br>
- Add files `TestAssignment.[extension]` and `Test_TestAssignment.[extension]` to a **.zip archive** named NameSurname.zip. For example: `JaneDoe.zip`<br>
...
We will use Java as an example language. <br>
